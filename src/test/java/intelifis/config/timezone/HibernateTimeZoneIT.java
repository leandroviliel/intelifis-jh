package intelifis.config.timezone;

import intelifis.IntelifisApp;
import intelifis.repository.timezone.DateTimeWrapper;
import intelifis.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = IntelifisApp.class)
